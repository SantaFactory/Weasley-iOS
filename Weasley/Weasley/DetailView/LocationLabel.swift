...
class LocationLabel: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        centreArcPerpendicular(text: allText, context: context, radius: ((self.bounds.size.width - 25) / 2) - 20, angle: 0, colour: UIColor.systemBackground, font: UIFont.systemFont(ofSize: 25, weight: .light), clockwise: true)
    }
